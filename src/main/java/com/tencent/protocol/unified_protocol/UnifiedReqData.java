...
public class UnifiedReqData {
    ...
    private String trade_type = ""; //交易类型 取值如下：JSAPI，NATIVE，APP，WAP,详细说明见参数规定
     ...
     */
    public UnifiedReqData(String body,String detail,String attach,String outTradeNo,int totalFee,
            String deviceInfo,String spBillCreateIP,String timeStart,String timeExpire,String goodsTag,
