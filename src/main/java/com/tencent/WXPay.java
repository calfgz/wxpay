...
public class WXPay {
    ...
    public static void initSDKConfiguration(String key,String appID,String mchID){
        WXPay.initSDKConfiguration(key, appID, mchID, "", "", "", "", 0);
    }
    ...
    public static void initSDKConfiguration(String key,String appID,String mchID,String sdbMchID,String certLocalPath,String certPassword){
        WXPay.initSDKConfiguration(key, appID, mchID, sdbMchID, certLocalPath, certPassword, "", 0);
    }
    ...
    public static void initSDKConfiguration(String key,String appID,String mchID,String sdbMchID,String certLocalPath,String certPassword,
        ...
        Configure.setProxyhost(proxyhost);
        Configure.setProxyport(proxyport);
    }
     ...
     * @throws Exception
     */
    public static String requestUnidiedService(UnifiedReqData unifiedReqData) throws Exception {
        return new UnifiedService().request(unifiedReqData);
    }
     ...
     * @throws Exception
     */
    public static String requestCloseService(CloseReqData closeReqData) throws Exception {
